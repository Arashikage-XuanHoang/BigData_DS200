...
Sau khi push, nộp link repo GitHub theo yêu cầu của đề bài. Nên kèm trong repo: ảnh chụp log
console khi hệ thống chạy, và/hoặc ảnh chụp output của `view_results.py` hoặc mongosh để minh
chứng kết quả đã được lưu thành công.
